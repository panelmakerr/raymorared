                  ...
                  {items.map((item, index) => (
                    ...
                    >
                      <div
                        ...
                        style={{ backgroundColor: item.selectedColor ? '#1a1a1a' : '#36454f' }}
                      >
            ...
            {items.length > 0 && (
              <div className="p-6 border-t border-gray-100 bg-gray-50">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm font-medium">{convertPrice(total, currency)}</span>
                </div>
                <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center justify-between mb-4 pt-2 border-t border-gray-200">
                  ...
                  <span className="text-xl font-bold text-gray-900">{convertPrice(total, currency)}</span>
                </div>
                <motion.button
