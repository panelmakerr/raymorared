        ...
        {filteredProducts.length === 0 ? (
          ...
          >
            {filteredProducts.map((product) => (
              viewMode === 'grid' ? (
                <TiltCard key={product.id} className="relative">
                  <motion.div
                    ...
                    <div className="aspect-square bg-gray-100 rounded-2xl overflow-hidden mb-4 relative">
                      ...
                      >
                        <div className="text-center">
                          <motion.div
                            className="w-20 h-20 mx-auto rounded-2xl mb-2"
                            style={{ backgroundColor: product.colors[0].hex }}
                            animate={{
                              rotate: hoveredId === product.id ? [0, 5, -5, 0] : 0,
                              scale: hoveredId === product.id ? 1.1 : 1,
                            }}
                            transition={{ duration: 0.4 }}
                          />
                      ...
                      <motion.button
                        ...
                        className="absolute bottom-4 left-4 right-4 bg-gray-900 text-white text-sm font-medium py-3 rounded-xl shadow-lg hover:bg-gray-800 transition-colors"
                      >
                        Quick Add
                      </motion.button>
                ...
                >
                  <motion.div
                    ...
                    className="w-32 h-32 bg-gray-200 rounded-xl flex items-center justify-center flex-shrink-0"
                  >
                    <div
